...
This package provides MoonBit wrappers for the Web MIDI API.
...
- JavaScript: `requestMIDIAccess()` → MoonBit: `request_midi_access()`
- JavaScript: `onmidimessage` → MoonBit: `set_on_midi_message()`
...
- Define `#external` types for Web MIDI API objects
...
This package must only contain Web MIDI API wrappers and must not include any application-specific logic.

**Allowed:**
- Type definitions for Web MIDI API objects
- Methods that directly correspond to Web MIDI API methods
- Helper functions for type conversions

**Not Allowed:**
- MIDI message interpretation (note on/off, pitch parsing)
- Music notation processing
- Application state management
- UI-specific MIDI handling
